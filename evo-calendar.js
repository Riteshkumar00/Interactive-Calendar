...
;(function(factory) {
    ...
    evo.prototype.init = function(init) {
        var _ = this;
    ...
    evo.prototype.destroy = function() {
        var _ = this;
        // code here
    ...
    // v1.0.0 - Limit title (...)
    evo.prototype.limitTitle = function(title, limit) {
        var newTitle = [];
    ...
    evo.prototype.stringCheck = function(d) {
        return d.replace(/[^\w]/g, '\\$&');
    }
            
    // v1.0.0 - Parse format (date)
    evo.prototype.parseFormat = function(format) {
        var _ = this;
    ...
    // v1.0.0 - Format date
    evo.prototype.formatDate = function(date, format, language) {
        var _ = this;
        if (!date)
            return '';
    ...
    evo.prototype.getBetweenDates = function(dates) {
    ...
    evo.prototype.isBetweenDates = function(active_date, dates) {
        var sd, ed;
    ...
    evo.prototype.hasSameDayEventType = function(date, type) {
    ...
    evo.prototype.setTheme = function(themeName) {
        var _ = this;
    ...
    evo.prototype.resize = function() {
        ...
        if (_.windowW <= _.$breakpoints.tablet) { // tablet
            ...
            if (_.windowW <= _.$breakpoints.mobile) { // mobile
                $(window)
                    .off('click.evo.evo-' + _.instanceUid)
            } else {
                $(window)
                    .on('click.evo.evo-' + _.instanceUid, $.proxy(_.toggleOutside, _));
            }
        } else {
            if (!_.options.sidebarDisplayDefault) _.toggleSidebar(false);
            else _.toggleSidebar(true);
    ...
    evo.prototype.initEventListener = function() {
        var _ = this;

        // resize
        $(window)
            .off('resize.evo.evo-' + _.instanceUid)
            .on('resize.evo.evo-' + _.instanceUid, $.proxy(_.resize, _));

        // IF sidebarToggler: set event listener: toggleSidebar
        if(_.options.sidebarToggler) {
            _.$elements.sidebarToggler
            .off('click.evo')
            .on('click.evo', _.toggleSidebar);
        }
        ...
        if(_.options.eventListToggler) {
            ...
            .off('click.evo')
            .on('click.evo', _.toggleEventList);
        }

        // set event listener for each month
        _.$elements.sidebarEl.find('[data-month-val]')
        .off('click.evo')
        .on('click.evo', _.selectMonth);

        // set event listener for year
        _.$elements.sidebarEl.find('[data-year-val]')
        .off('click.evo')
        .on('click.evo', _.selectYear);

        // set event listener for every event listed
        _.$elements.eventEl.find('[data-event-index]')
        .off('click.evo')
        .on('click.evo', _.selectEvent);
    };
    
    // v1.0.0 - Destroy event listeners
    evo.prototype.destroyEventListener = function() {
        var _ = this;
        
        $(window).off('resize.evo.evo-' + _.instanceUid);
        $(window).off('click.evo.evo-' + _.instanceUid);
    ...
    evo.prototype.calculateDays = function() {
    ...
    evo.prototype.buildTheBones = function() {
        var _ = this;
        _.calculateDays();
    ...
    evo.prototype.buildEventList = function() {
    ...
    evo.prototype.addEventList = function(event_data) {
        var _ = this, markup;
        var eventListEl = _.$elements.eventEl.find('.event-list');
    ...
    evo.prototype.removeEventList = function(event_data) {
        var _ = this, markup;
        var eventListEl = _.$elements.eventEl.find('.event-list');
    ...
    evo.prototype.buildSidebarYear = function() {
        var _ = this;
    ...
    evo.prototype.buildSidebarMonths = function() {
        var _ = this;
    ...
    evo.prototype.buildCalendar = function() {
    ...
    evo.prototype.addEventIndicator = function(event) {
    ...
    evo.prototype.removeEventIndicator = function(event) {
        var _ = this;
        var event_date = event.date;
        var type = _.stringCheck(event.type);
    ...
    ****************/
    ...
    evo.prototype.buildEventIndicator = function() {
        var _ = this;
    ...
    // v1.0.0 - Select event
    evo.prototype.selectEvent = function(event) {
        var _ = this;
    ...
    // v1.0.0 - Select year
    evo.prototype.selectYear = function(event) {
        var _ = this;
        var el, yearVal;
    ...
    // v1.0.0 - Select month
    evo.prototype.selectMonth = function(event) {
        var _ = this;
    ...
    evo.prototype.selectDate = function(event) {
        var _ = this;
    ...
    evo.prototype.getActiveDate = function() {
        var _ = this;
        return _.$active.date;
    }
    
    // v1.0.0 - Return active events
    evo.prototype.getActiveEvents = function() {
        var _ = this;
        return _.$active.events;
    }

    // v1.0.0 - Hide Sidebar/Event List if clicked outside
    evo.prototype.toggleOutside = function(event) {
    ...
    evo.prototype.toggleSidebar = function(event) {
        var _ = this;
    ...
    evo.prototype.toggleEventList = function(event) {
        var _ = this;
    ...
    evo.prototype.addCalendarEvent = function(arr) {
        var _ = this;
    ...
    evo.prototype.removeCalendarEvent = function(arr) {
        var _ = this;
    ...
    evo.prototype.isValidDate = function(d){
    ...
    $.fn.evo = function() {
        ...
        for (i = 0; i < l; i++) {
            if (typeof opt == 'object' || typeof opt == 'undefined')
                _[i].evo = new evo(_[i], opt);
            else
                ret = _[i].evo[opt].apply(_[i].evo, args);
